  ...
  return (
    <main className="welcome-page">
      ...
      <section className="welcome-stage">
        ...
        >
          <BrandLockup />
          <h1>{isDriver ? 'Welcome to the GoRide Driver Community' : 'Enjoy Your Ride With GoRide'}</h1>
          <p>
            {isDriver
              ? 'Start accepting rides, grow your earnings, and become part of the GoRide network.'
